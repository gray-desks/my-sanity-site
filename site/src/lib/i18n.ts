...
export const UI_LABELS = {
  ...
  vi: {
    ...
    noArticlesSubtitle: 'Vui lòng tạo bài viết đầu tiên trong hệ thống quản lý',
  },
  ...
  ms: {
    ...
    noArticlesTitle: 'Belum ada artikel',
    noArticlesSubtitle: 'Sila cipta artikel pertama di sistem pengurusan',
  },
  ...
  tl: {
    ...
    noArticlesSubtitle: 'Mangyaring lumikha ng unang artikulo sa sistema ng pamamahala',
  },
  fr: {
    readMore: 'Lire plus',
