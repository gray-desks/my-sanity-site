...
export const UI_LABELS = {
  ja: {
    ...
    searchKeyword: '検索キーワード入力',
    filters: 'フィルター',
    toggleFilters: 'フィルター切り替え',
    allTypes: 'すべて',
    spot: 'スポット',
    food: 'グルメ',
    transport: '交通',
  ...
  en: {
    ...
    searchKeyword: 'Search keyword input',
    filters: 'Filters',
  ...
  th: {
    ...
    searchKeyword: 'ป้อนคำสำคัญการค้นหา',
    filters: 'ตัวกรอง',
    toggleFilters: 'สลับตัวกรอง',
    allTypes: 'ทุกประเภท',
  ...
  id: {
    ...
    searchKeyword: 'Input kata kunci pencarian',
    filters: 'Filter',
  ...
  fr: {
    ...
    searchKeyword: 'Saisie mot-clé de recherche',
    filters: 'Filtres',
    toggleFilters: 'Basculer filtres',
    allTypes: 'Tous types',
    spot: 'Lieu',
    food: 'Nourriture',
    transport: 'Transport',
  ...
  es: {
    ...
    searchKeyword: 'Ingresar palabra clave de búsqueda',
    filters: 'Filtros',
  ...
  it: {
    ...
    searchKeyword: 'Inserimento parola chiave ricerca',
    filters: 'Filtri',
    toggleFilters: 'Alterna filtri',
  ...
  pt: {
    ...
    searchKeyword: 'Entrada de palavra-chave de pesquisa',
    filters: 'Filtros',
    toggleFilters: 'Alternar filtros',
  ...
  ru: {
    ...
    searchKeyword: 'Ввод ключевого слова поиска',
    filters: 'Фильтры',
  ...
  ar: {
    ...
    searchKeyword: 'إدخال كلمة مفتاحية للبحث',
    filters: 'مرشحات',
    toggleFilters: 'تبديل المرشحات',
  ...
  nl: {
    ...
    searchKeyword: 'Zoektrefwoord invoeren',
    filters: 'Filters',
    toggleFilters: 'Filters omschakelen',
    allTypes: 'Alle types',
    spot: 'Plaats',
    food: 'Eten',
    transport: 'Vervoer',
  ...
  pl: {
    ...
    searchKeyword: 'Wprowadź słowo kluczowe wyszukiwania',
    filters: 'Filtry',
    toggleFilters: 'Przełącz filtry',
  ...
  sv: {
    ...
    searchKeyword: 'Sökord inmatning',
    filters: 'Filter',
  ...
  da: {
    ...
    searchKeyword: 'Søgeord indtastning',
    filters: 'Filtre',
    toggleFilters: 'Skift filtre',
    allTypes: 'Alle typer',
    spot: 'Sted',
    food: 'Mad',
    transport: 'Transport',
    ...
    searchKeyword: 'Hakusanan syöttö',
    filters: 'Suodattimet',
    toggleFilters: 'Vaihda suodattimia',
  ...
  tr: {
    ...
    searchKeyword: 'Arama anahtar kelimesi girişi',
    filters: 'Filtreler',
    toggleFilters: 'Filtreleri aç/kapat',
    allTypes: 'Tüm Türler',
    spot: 'Yer',
    food: 'Yemek',
    transport: 'Ulaşım',
  ...
  'pt-br': {
    ...
    searchKeyword: 'Entrada de palavra-chave de busca',
    filters: 'Filtros',
    toggleFilters: 'Alternar filtros',
    allTypes: 'Todos os tipos',
    spot: 'Local',
