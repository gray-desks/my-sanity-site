...
export const UI_LABELS = {
  ...
  ms: { siteTitle: 'Log Perjalanan', home: 'Laman Utama' } as any,
  tl: { siteTitle: 'Travel Log', home: 'Home' } as any,
  fr: { siteTitle: 'Journal de Voyage', home: 'Accueil' } as any,
  de: { siteTitle: 'Reisetagebuch', home: 'Startseite' } as any,
  es: { siteTitle: 'Diario de Viaje', home: 'Inicio' } as any,
  it: { siteTitle: 'Diario di Viaggio', home: 'Casa' } as any,
  pt: { siteTitle: 'Diário de Viagem', home: 'Início' } as any,
  ru: { siteTitle: 'Дневник путешествий', home: 'Главная' } as any,
  ar: { siteTitle: 'مذكرات السفر', home: 'الرئيسية' } as any,
  hi: { siteTitle: 'यात्रा डायरी', home: 'होम' } as any,
  tr: { siteTitle: 'Seyahat Günlüğü', home: 'Ana Sayfa' } as any,
  'pt-br': { siteTitle: 'Diário de Viagem', home: 'Início' } as any,
} as const
...
// シンプル版（現在の使用向け）
export function getUILabelSimple(key: keyof typeof UI_LABELS.ja): string {
  return UI_LABELS.ja[key]
}